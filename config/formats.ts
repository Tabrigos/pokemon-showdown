...
export const Formats: FormatList = [
	...
	
	{
		...
		banlist: [
			...
			'Steel Memory', 'Oran Berry', 'Rocky Helmet', 'Shell Bell', 'Sitrus Berry', 'Wiki Berry', 'Harvest + Jaboca Berry', 'Harvest + Rowap Berry', "all items", "no item", 'Uber',
		],
		onValidateSet(set) {
    ...
    for (const set of team) {
        ...
        color.push(species.color);
    }
    for(var i = 0; i < color.length - 1; i++) {
        if(color[i] !== color[i+1]) {
            return ['i colori sono diversi'];
        }
    }
	...
	{
		name: "[Gen 8] Lv50 CG Co-Op! 3-3",
		mod: "gen8",
		gameType: 'multi',
		searchShow: false,
		tournamentShow: false,
		rated: false,
		ruleset: ['Team Preview', 'Cancel Mod', 'Max Team Size = 6', 'Max Move Count = 24', 'Max Level = 9999', 'Picked Team Size = 3', 'Adjust Level = 50'],
		
		
		
	},
	{
		name: "[Gen 8] Lv50 CG Co-Op! 6-6",
		mod: "gen8",
		gameType: 'multi',
		searchShow: false,
		tournamentShow: false,
		rated: false,
		ruleset: ['Team Preview', 'Cancel Mod', 'Max Team Size = 6', 'Max Move Count = 24', 'Max Level = 9999', 'Adjust Level = 50'],
