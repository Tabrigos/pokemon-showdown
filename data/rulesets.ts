...
export const Rulesets: {[k: string]: FormatData} = {
	...
	standardnatdexexacthp: {
		effectType: 'ValidatorRule',
		name: 'Standard NatDex Exact Hp',
		desc: "The standard ruleset for all National Dex tiers",
		ruleset: [
			'Obtainable', '+Unobtainable', '+Past', 'Sketch Gen 8 Moves', 'Team Preview', 'Nickname Clause', 'Exact HP Mod', 'Cancel Mod', 'Endless Battle Clause',
		],
		onValidateSet(set) {
